...
var file_sso_proto_depIdxs = []int32{
	...
	2,  // 7: sso.Auth.Login:output_type -> sso.LoginResp
	4,  // 8: sso.Auth.GenerateQrcode:output_type -> sso.QrcodeResp
	6,  // 9: sso.Auth.CheckQrcodeStatus:output_type -> sso.QrcodeStatusResp
	2,  // 10: sso.Auth.ConfirmQrcodeLogin:output_type -> sso.LoginResp
	9,  // 11: sso.Auth.VerifyToken:output_type -> sso.VerifyResp
	9,  // 12: sso.Auth.Logout:output_type -> sso.VerifyResp
