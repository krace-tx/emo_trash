...
func (c *authClient) Logout(ctx context.Context, in *LogoutReq, opts ...grpc.CallOption) (*VerifyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyResp)
...
type AuthServer interface {
	...
	// 用户登出
	Logout(context.Context, *LogoutReq) (*VerifyResp, error)
...
func (UnimplementedAuthServer) Logout(context.Context, *LogoutReq) (*VerifyResp, error) {
